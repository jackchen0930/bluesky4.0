...
import com.tongyong.ct.mycore.googlevolley.Network;
import com.tongyong.ct.mycore.googlevolley.NetworkResponse;
import com.tongyong.ct.mycore.googlevolley.RequestQueue;
import com.tongyong.ct.mycore.googlevolley.RequestTickle;
import com.tongyong.ct.mycore.googlevolley.cache.DiskBasedCache;
import com.tongyong.ct.mycore.googlevolley.misc.NetUtils;
import com.tongyong.ct.mycore.googlevolley.misc.Utils;
...
public class VolleyTickle {
    ...
    /**
     * Creates a default instance of the worker pool and calls {@link com.tongyong.ct.mycore.googlevolley.RequestTickle#start()} on it.
     *
     * @param context A {@link android.content.Context} to use for creating the cache dir.
     * @param stack An {@link com.tongyong.ct.mycore.googlevolley.toolbox.HttpStack} to use for the network, or null for default.
     * @return A started {@link com.tongyong.ct.mycore.googlevolley.RequestTickle} instance.
     */
