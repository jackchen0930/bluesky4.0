...
package com.tongyong.ct.adapter;
...
import com.tongyong.ct.util.ValueInterpolator;
...
public class ColorItemsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ColorItemsAdapter(Context context, int numberOfItems) {
        ...
        int startColor = context.getResources().getColor(R.color.blueviolet);
        int startR = Color.red(startColor);
        int startG = Color.green(startColor);
        int startB = Color.blue(startColor);

        int endColor = context.getResources().getColor(R.color.red);
